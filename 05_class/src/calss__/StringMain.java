...
public class StringMain {
	...
	public static void main(String[] args) {
		...
		if(c == d)System.out.println("a와 b의 참조값은 같다");
		else System.out.println("a와 b의 참조값은 다르다");
		if(c.equals(d))System.out.println("a와 b의 문자열은 같다");
		else System.out.println("a와 b의 문자열은 다르다");
		System.out.println();
		...
		/*
		 문자열은 편집이 안된다. -> 메모리에 4번에 생성이 일어난다
		 JVM에 의해서 삭제 시 Garbage Collector로 보낸다
		 Garbage Collector가 실행되면 컴터는 멈춥
		 */
		...
		System.out.println("부분 문자열 추출=" +e.substring(7,11));// 7번부터 10번
